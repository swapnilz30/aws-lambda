...
const getSubs = async () => {
  const subscribers = await axios.get(
    "https://nxgxix2ude.execute-api.us-east-1.amazonaws.com/dev/getSubscribers"
  );
  var list = [];
...
const getQuote = async () => {
  const getQuotes = await axios.get(
    "https://nxgxix2ude.execute-api.us-east-1.amazonaws.com/dev/quotes"
  );
